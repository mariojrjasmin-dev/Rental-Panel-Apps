...
backend:
  - task: "Pre-paid Refuel option per location + Rental Terms acceptance (refuel_amount in Location, /api/settings/rental-terms GET, /api/admin/settings/rental-terms PUT, BookingCreate refuel_opted_in/terms_accepted, total includes refuel applied to taxable_amount)"
    implemented: true
    working: true
