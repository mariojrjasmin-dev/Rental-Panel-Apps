...
user_problem_statement: "Add a promo codes / discount system. Admins create codes (percent or fixed value, max uses, expiry, min order). Customers apply at checkout via the mobile booking screen. Booking must validate and apply the discount on subtotal before tax."
