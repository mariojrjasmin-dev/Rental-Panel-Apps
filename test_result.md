...
user_problem_statement: "Add insurance_included flag per location. Admin toggles it via Location form. Mobile booking screen shows a clear badge: 'Insurance included' (green) or 'Insurance NOT included' (orange). No add-on tiers needed, just an info flag."
