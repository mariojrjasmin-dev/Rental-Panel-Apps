...
backend:
  - task: "Admin bulk-cancel all pending pickup bookings (POST /api/admin/bookings/cancel-pending-pickups)"
    implemented: true
    working: true
...
test_plan:
  current_focus:
    - "Admin bulk-cancel all pending pickup bookings (POST /api/admin/bookings/cancel-pending-pickups)"
  stuck_tasks: []
  test_all: false
