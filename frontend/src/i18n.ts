...
const translations = {
  en: {
    ...
    confirmYourBookingSub: 'Please review your reservation details before confirming.',
    confirmAndBook: 'Confirm & Book',
    backToEdit: 'Back to Edit',
    // ---- Cancel booking ----
    cancelBooking: 'Cancel Booking',
    cancelBookingTitle: 'Cancel this booking?',
    cancelBookingSub: 'Your reservation will be cancelled and the vehicle will be returned to the available inventory. No refund is needed because payment is collected at pickup.',
    cancellationPolicy: 'Cancellations must be made at least 24 hours before pickup.',
    keepBooking: 'Keep Booking',
    confirmCancelBooking: 'Yes, Cancel It',
    bookingCancelled: 'Booking cancelled',
    cancelBookingFailed: 'Could not cancel the booking. Please try again.',
  ...
  es: {
    ...
    confirmYourBookingSub: 'Por favor revisa los detalles de tu reserva antes de confirmar.',
    confirmAndBook: 'Confirmar y Reservar',
    backToEdit: 'Volver a editar',
    // ---- Cancel booking ----
    cancelBooking: 'Cancelar reserva',
    cancelBookingTitle: '¿Cancelar esta reserva?',
    cancelBookingSub: 'Tu reserva será cancelada y el vehículo regresará al inventario disponible. No se requiere reembolso porque el pago se realiza al momento de la recogida.',
    cancellationPolicy: 'Las cancelaciones deben realizarse al menos 24 horas antes de la recogida.',
    keepBooking: 'Mantener reserva',
    confirmCancelBooking: 'Sí, cancelar',
    bookingCancelled: 'Reserva cancelada',
    cancelBookingFailed: 'No se pudo cancelar la reserva. Por favor intenta de nuevo.',
